...
<%
  ...
  if (id == null) {
    ...
    if(!session_actual.getAttribute("id_rol").toString().equals("2")){
      response.sendRedirect("index.jsp");
    }
%>
<!DOCTYPE html>
...
<div class="container">
    ...
    <form action="controllerCasos.jsp" method="post">
        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-10">
              <input type="text" class="form-control" id="descripcion_requerimiento" name="descripcion_requerimiento" value="<%= caso.getDescripcion_requerimiento() %>" required>
            </div>
        ...
        <a href="casos.jsp" class="btn btn-secondary">Cancelar</a>
    </form>
    <%}%>
</div>
