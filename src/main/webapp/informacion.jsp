    ...
    <div class="row g-3 align-items-center">
        ...
        <div class="col-10">
            <select class="form-select" name="sexo" id="sexo" disabled>
                <option <% if(session_actual.getAttribute("sexo") == "Masculino"){ out.println("selected");}%>>Masculino</option>
                <option <% if(session_actual.getAttribute("sexo") == "Femenino"){ out.println("selected");}%>>Femenino</option>
            </select>
        </div>
        ...
        <div class="col-10">
            <input type="text" class="form-control" id="id_rol" name="id_rol" readonly="true" value="<%=session_actual.getAttribute("id_rol") %>">
        </div>
        <div class="col-2">
            <label for="id_departamento" class="col-form-label">Departamento: </label>
        </div>
        <div class="col-10">
            <input type="text" class="form-control" id="id_departamento" name="id_departamento" readonly="true" value="<%=session_actual.getAttribute("id_departamento") %>">
        </div>
    </div>
</div>
