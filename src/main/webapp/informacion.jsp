...
<div class="container">
    ...
    <br><br><h1>Informacion de la cuenta</h1><br>
    <div class="row g-3 align-items-center">
        <div class="col-2">
            <label for="nombre" class="col-form-label">Nombre completo: </label>
        </div>
        <div class="col-10">
            <input type="text" class="form-control" id="nombre" name="nombre" readonly="true" value="<%=session_actual.getAttribute("nombre") %>">
        </div>
        ...
        <div class="col-10">
            <input type="text" class="form-control" id="identificacion" name="identificacion" readonly="true" value="<%=session_actual.getAttribute("identificacion") %>">
        </div>
        ...
        <div class="col-10">
            <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" readonly="true" value="<%=session_actual.getAttribute("fecha_nacimiento") %>">
        </div>
        ...
        <div class="col-10">
            <select class="form-select" name="sexo" id="sexo" disabled>
                <option <% if(session_actual.getAttribute("sexo").equals("Masculino")){ out.println("selected");}%>>Masculino</option>
                <option <% if(session_actual.getAttribute("sexo").equals("Femenino")){ out.println("selected");}%>>Femenino</option>
            </select>
        </div>
        ...
        <div class="col-10">
            <input type="text" class="form-control" id="correo" name="correo" readonly="true" value="<%=session_actual.getAttribute("correo") %>">
        </div>
        ...
        <div class="col-10">
            <input type="text" class="form-control" id="password" name="password" readonly="true" value="<%=session_actual.getAttribute("password") %>">
        </div>
        <div class="col-2">
            <label for="id_rol" class="col-form-label">Rol de usuario: </label>
        </div>
        <div class="col-10">
            <input type="text" class="form-control" id="id_rol" name="id_rol" readonly="true" value="<%=session_actual.getAttribute("rol") %>">
        </div>
        <div class="col-2">
            <label for="id_departamento" class="col-form-label">Departamento: </label>
        </div>
        <div class="col-10">
            <input type="text" class="form-control" id="id_departamento" name="id_departamento" readonly="true" value="<%=session_actual.getAttribute("departamento") %>">
        </div>
    </div>
</div>
